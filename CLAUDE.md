...
- Gate D: IN PROGRESS — 326 tests passing + mypy verde.
  ...
  - D7 Cierre Gate D + tag v0.3-gate-d: PENDING (solo queda D2).
...
PYTHONPATH=src python -m pytest tests/ -q           # full suite (326 tests)
