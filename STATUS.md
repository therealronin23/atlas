...
| P09 | seguridad/eval/ops reales; Merkle base verificado; EngineeringFinding v1 y review determinista code+tests sin wiring | diagnóstico, routing gobernado, recovery y traffic evidence |
