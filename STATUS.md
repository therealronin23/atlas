...
| P09 | seguridad/eval/ops reales; Merkle base verificado; EngineeringFinding v1, review determinista y diagnóstico de captura/clasificación code+tests sin wiring | reproducción aislada, routing gobernado, recovery y traffic evidence |
