...
| P09 | seguridad/eval/ops reales; Merkle base verificado; EngineeringFinding v1 code+tests sin wiring | coordinadores, routing gobernado, recovery y traffic evidence |
