...
| OS-R4 | Node 18/Vite 5 causaban deriva y avisos en dependencias npm | medio | Node 22.22.2 + Vite 7 pineados; lock sin vulnerabilidades; instalación, audit y build en CI | CERRADO (2026-07-16) |
...
| OS-R7 | Pisar o filtrar cambios locales del operador al publicar | alto | diff declarado; staging selectivo; configuración Codex con secretos y export bruto ignorados antes de añadir; ledger actualizado bajo autorización explícita | MITIGADO (2026-07-16) |
