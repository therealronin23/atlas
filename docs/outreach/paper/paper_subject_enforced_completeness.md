...
*Auditable Agents* [arXiv:2604.05485, April 2026] proposes a framework for the
auditability of agent execution (tool calls and state transitions). It does not provide
subject-verifiable completeness of the log against a dishonest operator who controls the
logging infrastructure. Our contribution is precisely that case: a subject-side mechanism
that detects operator omissions without trusting the operator.

*Aegis* [arXiv:2603.16938, March 2026] provides cryptographic runtime governance for
autonomous agents, enforcing behavioral and policy compliance at execution time, enabling
attestation that an agent followed a declared policy. Aegis addresses **behavioral
compliance** (did the
...
- [x] Auditable Agents (arXiv:2604.05485, April 2026) — existence/title/authors confirmed via
      WebFetch; agent-execution auditability; technical specifics (Merkle log / honest-tool-provider)
      NOT individually confirmed → prose softened to the verifiable gap-claim (§5).
- [x] Aegis (arXiv:2603.16938, March 2026) — existence/title/author confirmed; runtime
      behavioral/policy compliance (orthogonal to inspection-log completeness); ZK-STARK specific
      NOT confirmed → prose softened (§5).
